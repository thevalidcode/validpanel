        ...
        >
          ...
          >
            ...
            <div className="sticky top-0 z-10 flex items-center gap-3 px-6 py-4 border-b border-gray-200 bg-white">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Configure platform, limits, and credentials for this gateway.
                </p>
              </div>
              <button
                type="button"
            ...
            <div className="px-6 py-5 space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Field label="Min Amount" icon={<Upload className="w-4 h-4" />}>
                  <input
                    required
                    value={form.min}
                    onChange={(e) =>
                ...
                <Field label="Max Amount" icon={<Upload className="w-4 h-4" />}>
                  <input
                    required
                    value={form.max}
                    onChange={(e) =>
              ...
              <Field label="Description" icon={<Pencil className="w-4 h-4" />}>
                <input
              ...
              {mode === "edit" && (
                <Field label="Status" icon={<CreditCard className="w-4 h-4" />}>
                  <CustomSelect
                    ref={statusSelectRef}
