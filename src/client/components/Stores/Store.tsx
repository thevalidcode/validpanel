...
const Store = () => {
  return (
    <div className={`w-full max-w-[554px] mx-auto h-[163px] md:h-[234px] rounded-[8.4px] border-l-4 border-l-primary border-[1.4px] border-vgrey-border px-3 xl:px-[23px] py-6 md:py-[35px] `} >
          ...
          <div className="w-full flex justify-between">
            <div className="flex gap-2 md:gap-[18px] ">
              ...
              <div className="flex flex-col justify-between items-start">
                <p className="text-sm font-bold md:text-xl ">Clark’s Skincare</p>
            ...
            <button className="flex gap-1 items-center w-[55px] md:w-[79px] bg-vgreen-light h-[18px] md:h-[26px] rounded-full justify-center">
              ...
              <span className="inline-block text-vgreen-dark text-[8px] md:text-sm "> Active </span>
            </button>
          </div>
          <p className="text-vgrey-text font-semibold text-xs md:text-base">Created on April 25, 2025</p>
        </div>
