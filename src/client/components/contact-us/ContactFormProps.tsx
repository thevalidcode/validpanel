...
const ContactForm: FC<ContactFormProps> = () => (
  <div className="container mx-auto mt-16 mb-32 px-4 grid md:grid-cols-2 gap-8 items-top">
    ...
    <form className="bg-white shadow-2xl p-6 border-2 border-purple-800 rounded-lg shadow-[#8000ff40]">
      ...
      <div className="flex gap-2 mb-2">
        <input
          ...
          className="w-1/2 border-0 bg-gray-50 p-2 rounded"
        />
        <input
          type="text"
      ...
      <input
        ...
        className="w-full border-0 bg-gray-50 p-2 rounded mb-2"
      />
      <textarea
        placeholder="Type your message*"
        className="w-full border-0 bg-gray-50 p-2 rounded mb-4"
        rows={10}
      ></textarea>
      <button
        type="submit"
