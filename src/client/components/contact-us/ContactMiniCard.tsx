...
const ContactMiniCard: FC<ContactMiniCardProps> = ({
  icon,
  title,
  description,
}) => (
  <div className="flex flex-col items-center bg-white p-6 rounded-[4px] text-center shadow-xl shadow-[#8000ff40] border border-purple-100">
