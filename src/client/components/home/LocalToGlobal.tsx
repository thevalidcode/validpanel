      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-24">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-gray-900">
            ...
            <span className="text-[var(--color-primary)]">Global Empire</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ValidPanel removes the borders from your business. We handle the
            complexity of international logistics and payments invisibly.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          {[
            {
              title: "Local Store",
              desc: "You start selling to your local community.",
              icon: <FaUserFriends />,
            },
            {
              title: "National Logistics",
              desc: "We automatically route orders through nationwide partners.",
              icon: <FaBox />,
            },
            {
              title: "Global Payments",
              desc: "Accept USD, GBP, and EUR instantly.",
              icon: <FaCreditCard />,
            },
            {
              title: "International Shipping",
              desc: "Cross-border delivery handling enabled.",
              icon: <FaPlane />,
            },
          ].map((step, i) => (
            <div
              key={i}
              className={`flex flex-col md:flex-row items-center mb-24 relative ${i % 2 === 0 ? "md:flex-row-reverse" : ""}`}
            >
          ...
          {/* Final Globe */}
          <motion.div
            className="relative z-10 flex justify-start md:justify-center pt-8"
            style={{ opacity }}
          >
            <div className="ml-[38px] md:ml-0 -translate-x-1/2 md:translate-x-0">
