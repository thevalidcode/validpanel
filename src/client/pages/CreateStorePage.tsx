...
const CreateStoreForm: React.FC = () => {
  ...
  const { data: stores, isLoading: isStoresLoading } = useGetUserStores();
  ...
  if (!subscription) {
    return (
      <NotFound
        ...
        description="You haven't subscriped to any plan yet."
            ...
            >
              ...
              <div className="mb-6 rounded-lg p-4 sm:p-6">
                ...
                <DomainInput
                  ...
                  showUseCustomDomain={
                    subscription.plan?.features?.custom_domain ?? false
                  }
