    ...
    <Toaster
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          actionButton:
            "ml-auto shrink-0 rounded-[4px] bg-primary px-3 py-1.5 sm:px-3.5 sm:py-2 text-xs sm:text-sm font-semibold text-white transition-all hover:bg-[#6a18d9] active:scale-95 shadow-sm",
          cancelButton:
            "shrink-0 rounded-[4px] border border-gray-300 bg-white px-3 py-1.5 sm:px-3.5 sm:py-2 text-xs sm:text-sm font-medium text-gray-700 transition-all hover:bg-gray-50 active:scale-95",
          closeButton:
            "absolute right-2 top-2 sm:right-2.5 sm:top-2.5 rounded-[4px] p-1 text-gray-400 transition-all hover:text-gray-600 hover:bg-gray-100 active:scale-95 opacity-0 group-hover:opacity-100",
          success:
