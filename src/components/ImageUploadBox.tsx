      ...
      return (
        <div className="flex flex-col items-start">
          <motion.label
            ...
            whileTap={{ scale: 0.98 }}
            className="border border-gray-300 px-4 py-2 rounded-[4px] text-sm hover:bg-gray-100 transition cursor-pointer inline-flex items-center justify-center disabled:opacity-50"
          >
    ...
    return (
      <div className="mb-6">
        ...
        <motion.label
          ...
          whileTap={{ scale: 0.98 }}
          className="border-2 border-dashed border-gray-300 rounded-[4px] p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:border-[var(--color-primary)] transition"
        >
